      ...
      <div className={styles.container}>
        <div className={`${styles.content} ${isVisible ? styles.fadeIn : ''}`}>
          ...
          <div className={styles.brandSection}>
            <h3 className={styles.brandName}>TiffinBox</h3>
            <p className={styles.tagline}>Home on your plate.</p>
            <div className={styles.socialLinks}>
              ...
              <a 
                href="https://instagram.com/tiffinbox" 
                className={styles.socialLink}
          ...
          <div className={styles.legalSection}>
            ...
            <p className={styles.copyright}>
              © 2025 TiffinBox. All rights reserved.
            </p>
          </div>
        </div>
      </div>
